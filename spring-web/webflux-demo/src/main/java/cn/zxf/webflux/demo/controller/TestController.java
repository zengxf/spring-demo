...
public class TestController {
    ...
    public Map<String, Object> findOne( @PathVariable String id ) {
        Map<String, Object> map = Map.of( "id", id, "name", "峰-" + id, "status", 1, "date", System.currentTimeMillis() );
    ...
    public Map<String, Object> updateOne( @RequestBody Map<String, Object> body ) {
        ...
        Map<String, Object> map = Map.of( "msg", "ok", "body", body, "code", 1, "date", System.currentTimeMillis() );
    ...
    public Map<String, Object> putOne( @RequestBody Map<String, Object> body ) {
        ...
        Map<String, Object> map = Map.of( "msg", "ok", "body", body, "code", 2, "date", System.currentTimeMillis() );
    ...
    public Map<String, Object> patchOne( @RequestBody Map<String, Object> body ) {
        ...
        Map<String, Object> map = Map.of( "msg", "ok", "body", body, "code", 3, "date", System.currentTimeMillis() );
    ...
    public Map<String, Object> deleteOne( @PathVariable String id ) {
        Map<String, Object> map = Map.of( "id", id, "name", "峰-" + id, "delete-status", 1, "date", System.currentTimeMillis() );
